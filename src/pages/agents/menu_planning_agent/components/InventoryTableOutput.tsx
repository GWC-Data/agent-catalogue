...
export const InventoryTableOutput = ({
  data,
  totalIngredients,
}: {
  data: InventoryRow[]
...
const [sorting, setSorting] = React.useState<SortingState>([])
  ...
  <div className="bg-white rounded-md shadow-sm border border-gray-200 p-4 mb-4">
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-sm">
      {Object.entries(totalIngredients).map(([ingredient, qty]) => (
        <div
          key={ingredient}
      ...
      <div className="flex items-center py-4">
        <div className="text-lg font-bold">Inventory Table</div>
