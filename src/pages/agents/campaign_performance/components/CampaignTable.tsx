...
export const columns: ColumnDef<Campaign>[] = [
  ...
  },
  {
    ...
    header: () => <div className="">Traffic Source</div>,
    cell: ({ row }) => {
      return <div className="font-medium">{row.getValue("traffic_source")}</div>
    },
  },
  {
    ...
    cell: ({ row }) => {
      return <div className="font-medium">{row.getValue("impressions")}</div>
    },
  }
  ,
  {
    ...
    cell: ({ row }) => {
      return <div className="font-medium">{row.getValue("clicks")}</div>
    }
  },
  {
    ...
    cell: ({ row }) => {
      return <div className="font-medium">{row.getValue("conversions")}</div>
    }
  },
  {
    accessorKey: "spend",
    ...
    cell: ({ row }) => {
      return <div className="font-medium">{row.getValue("spend")}</div>
    }
  },
  {
    accessorKey: "revenue",
    ...
    cell: ({ row }) => {
      return <div className="font-medium">{row.getValue("revenue")}</div>
    }
  },
  {
    accessorKey: "budget",
    ...
    cell: ({ row }) => {
      return <div className="font-medium">{row.getValue("budget")}</div>
    }
  },
