...
export const columns: ColumnDef<BottomTen>[] = [
  {
...
export function BottomTenOutput({ data }: { data: BottomTen[] }) {
  ...
  return (
    <div className="w-full bg-white rounded-md px-6 py-3 shadow-sm border border-gray-200">
      <div className="flex items-center py-4">
        <div className="text-lg font-bold">Bottom Ten</div>
        <DropdownMenu>
