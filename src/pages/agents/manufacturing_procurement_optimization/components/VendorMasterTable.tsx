...
export const columns: ColumnDef<VendorMasterRow>[] = [
    {
      ...
      {
        accessorKey: "vendor_score",
        header: () => <div>Vendor Score</div>,
        cell: ({ row }) => (
          <div>
            {row.getValue("vendor_score")}
          </div>
        ),
      },
      {
...
export function VendorMasterTable({ data }: { data: VendorMasterRow[] }) {
  ...
  return (
    <div className="w-full bg-white rounded-md px-6 py-3 shadow-sm border border-gray-200">
      <div className="flex items-center py-4">
        <div className="text-lg font-bold">Vendor Master Table</div>
        <DropdownMenu>
