...
const FitmentScoresTableOutput = ({ data }: { data: FitmentScoresRow[] }) => {
    ...
    return (
      <div className="w-full bg-white rounded-md px-6 py-3 shadow-sm border border-gray-200">
        <div className="flex items-center py-4">
          <div className="text-lg font-bold">Fitment Scores Table</div>
          <DropdownMenu>
...
export default FitmentScoresTableOutput