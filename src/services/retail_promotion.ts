...
export const fetchLivePromotionsAPI = async () => {
    const res = await fetch("https://retail-promotion-effectiveness-462434048008.asia-south1.run.app/api/v1/input/https://retail-promotion-effectiveness-462434048008.asia-south1.run.app/api/v1/input/live_promotions")
